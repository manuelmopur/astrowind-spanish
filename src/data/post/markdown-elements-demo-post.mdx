...
title: Publicación de demostración de elementos Markdown
excerpt: Sint sit cillum pariatur eiusmod nulla pariatur ipsum. Sit laborum anim qui mollit tempor pariatur nisi minim dolor. # O un nuevo extracto en español si este es placeholder
tags:
  - markdown
  - blog
  - Astro
...
## <a name="Horizontal"></a>Regla horizontal
...
| Encabezado de Tabla 1 | Encabezado de Tabla 2 | Alineación centrada | Alineación derecha | Encabezado de Tabla 5 |
| :-------------------- | :-------------------- | :-----------------: | -----------------: | :-------------------- |
...
Ad amet irure est magna id mollit Lorem in do duis enim. Excepteur velit nisi magna ea pariatur pariatur ullamco fugiat deserunt sint non sint. Duis duis est `código en texto` velit velit aute culpa ex quis pariatur pariatur laborum aute pariatur duis tempor sunt ad. Irure magna voluptate dolore consectetur consectetur irure esse. Anim magna `<strong>en culpa qui officia</strong>` dolor eiusmod esse amet aute cupidatat aliqua do id voluptate cupidatat reprehenderit amet labore deserunt.
...
func handler(w http.ResponseWriter, r *http.Request) {
    fmt.Fprintf(w, "Hola, ¡me encanta %s!", r.URL.Path[1:])
}
